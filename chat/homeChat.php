                            ...
                            <li class="each-user-search">
                                ...
                                <div class="each-user-search-child">
                                    <div class='img-user-search'
                                        style="background: url(/comp1841/crud/user/uploads/<?php echo $conversation['image']; ?>) no-repeat center center; width: 50px; height: 50px; border-radius: 50%; background-color: #ccc">
                                    </div>
