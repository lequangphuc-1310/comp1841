    ...
    <div class="import-img-container">
        ...
        <div class="import-img-content">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="image-container" style='margin: 3em auto; display:flex; justify-content: space-between; align-items: center'>
                    <div class="image-avt" style='width: 150px; border: 1px solid green; height: 150px; border-radius: 50%; background: #fff url(/comp1841/crud/user/uploads/<?php echo $_SESSION['user_image']; ?>) no-repeat center center; background-size: contain; margin: 2em;'>
                    </div>
                    <span class='transform-arrow'><i class="fas fa-angle-double-right"></i><i class="fas fa-angle-double-right"></i></span>
                    <div class="image-avt" style='width: 150px; border: 1px solid green; height: 150px; border-radius: 50%; background: #fff url(/comp1841/crud/user/uploads/<?php echo $_SESSION['new_user_image']; ?>) no-repeat center center; background-size: contain; margin: 2em;'>
                    </div>
                </div>
