        ...
        <div class="nav">
            <div class="nav-child-left">
                ...
                <div class="nav-child-search">
                    <button class="btnSearch-nav"><a href='/comp1841/crud/search/search.php'><i class="fas fa-search"></i></a>
                    </button>
                </div>
            ...
            <div class="nav-child-right">
                ...
                <div class="nav-user-avt">
                    <a href="/comp1841/crud/user/userInfo.php?userId=<?php echo $thisUserId; ?>">
                        ...
                        $img = $d['image'];
                        if ($img) { ?>
                            <div class="nav-user-avt-img" style="background: transparent url(/comp1841/crud/user/uploads/<?php echo $img; ?>) center center no-repeat; height: 30px; width: 30px; padding: 3px;background-size: contain">
                            </div>
                        <?php } else { ?>
                            <div class="nav-user-avt-img" style="background: transparent url(/comp1841/crud/user/uploads/IMG-653751dd87d0c4.57015077.png) center center no-repeat; height: 30px; width: 30px; padding: 3px;background-size: contain">
                            </div>
                        <?php }
                        ?>
                    </a>
