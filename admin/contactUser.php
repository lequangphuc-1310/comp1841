    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                admin_user.user_send, admin_user.admin_send from `user`, `admin_user` 
                where user.id = admin_user.user_id and admin_user.admin_send = '';");
                ...
                ?>
                        <tr class='w3-hover-green'>
                            ...
                            <td>
                                ...
                                <a class='text-light text-decoration-none' href='/comp1841/admin/replyUser.php?updateid=<?php echo $id; ?>'><button class='btn btn-edit'>Reply this user</button></a>
                                <a class='text-light text-decoration-none' href='/comp1841/crud/delete.php?deleteid=<?php echo $id; ?>'><button class='btn btn-delete'>Delete</button></a>
                            </td>
                        </tr>
                    <?php
                    }
